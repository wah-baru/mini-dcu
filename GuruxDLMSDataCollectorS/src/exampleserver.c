...
#include "../../development/include/gxinvoke.h"
...
void reads(dlmsSettings *settings, gxValueEventCollection *args, unsigned char ignoreValue)
{
    int ret, pos;
    gxValueEventArg *e;
    gxReplyData reply;
    ...
    gxPushSetup *push)
{
    ...
    if (pushSocket != -1)
    {
        ...
        if (ret == 0)
        {
            ...
            reads(&clientCon.settings, &args, 1);
            com_close(&clientCon);
