...
extern unsigned char SERVER_PDU[10 + PDU_BUFFER_SIZE];
extern unsigned char SERVER_FRAME[HDLC_HEADER_SIZE + PDU_BUFFER_SIZE];
extern unsigned char SERVER_REPLY_PDU[FRAME_SIZE];
extern unsigned char CLIENT_PDU[PDU_BUFFER_SIZE];
extern unsigned char CLIENT_REPLY_PDU[HDLC_HEADER_SIZE + PDU_BUFFER_SIZE];
extern unsigned char PUSH_PDU[HDLC_HEADER_SIZE + PDU_BUFFER_SIZE];
extern unsigned char PUSH_FRAME[HDLC_HEADER_SIZE + PDU_BUFFER_SIZE];

// Push messages are sent using this socket.
extern int pushSocket;
