...
broker = '127.0.0.1'
port = 1883
client_id = f'amrDLMS_ECU_meter4'
username = 'mgi'
password = 'admin@mgi'
...
jsonFileName = '/home/mgi/project/MINIDCU/python/dlms_json/meter4.json'
...
def clientSettings(dicts=dict):
    ...
    client.serverAddressSize = int(dicts['serverAddressSize'])
    ...
    # client.serverAddress = GXDLMSClient.getServerAddress(
    #   client.clientAddress, int(dicts['serverAddress']), client.serverAddressSize )
    # print(client.serverAddress)
    # print(client.serverAddressSize)
    # print(GXDLMSClient.getServerAddress(
    #     1, 16))
    client.serverAddress = GXDLMSClient.getServerAddress(1, 16)
    ...
    for i in dlmsConf:
        for v in i['body']:
            ...
            try:
                ...
                index_profile = 0
                print("instant profile : ", instant_profile_value)
